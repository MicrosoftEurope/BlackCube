...
void connectprotocol(char *protocolstring) // blackcube://example.org[:28763][/][?[port=28763][&password=secret]]
{
    urlparse u;
    u.set(protocolstring);
    if(strcmp(u.scheme, "blackcube") || !*u.domain) { conoutf("\f3bad commandline syntax (\"%s\")", protocolstring); return; }
...
int main(int argc, char **argv)
{
    ...
    initlog("video: misc");
    SDL_WM_SetCaption("BlackCube", NULL);
